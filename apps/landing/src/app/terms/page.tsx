    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            Classes 8&ndash;12 across CBSE, ICSE, Karnataka State Board (KSEAB), Tamil Nadu
        ...
        <section className="mb-10 bg-amber-50 border border-amber-200 rounded-xl p-6">
          ...
          <blockquote className="mt-4 pl-4 border-l-4 border-amber-400 text-gray-600 italic text-sm leading-relaxed">
            &copy; Textbook content belongs exclusively to its respective authors and authorities.
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            Access to premium content requires an active membership. Payments are processed
            securely via Razorpay through aienter.in. Membership grants access to all available
            boards, classes, and subjects for the duration of the subscription.
          </p>
          <p className="text-gray-600 leading-relaxed">
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-6 mt-10">
        <div className="max-w-4xl mx-auto px-4 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} IIS Academy. All rights reserved.</p>
          <p className="mt-1">
